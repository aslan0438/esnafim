...
export default function Dashboard() {
  ...
  return (
    <div className="space-y-8 animate-fade-in">
      ...
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-primary via-primary-container to-secondary-container p-6 text-on-primary shadow-lg sm:p-8">
        ...
        <div className="relative flex items-start justify-between">
          <div>
            ...
            <p className="mt-1 text-sm text-on-primary-variant max-w-md">
              İşletmenizin günlük özetini buradan takip edin. Randevularınız, siparişleriniz ve geliriniz tek bir bakışta.
            </p>
          </div>
      ...
      {/* Daily Summary Card (Shows at 20:00) */}
      ...
      <div className="grid gap-3 sm:grid-cols-3">
        <Link
          to="/randevular"
          className="group flex items-center gap-3 rounded-xl border border-outline-variant/20 bg-surface px-4 py-3 text-sm font-medium text-on-surface shadow-sm transition-all hover:border-primary/30 hover:shadow-md hover:text-primary"
        >
          <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-primary-container/10 transition-colors group-hover:bg-primary-container/20">
            <CalendarPlus className="h-4 w-4 text-primary" />
          </div>
          Yeni Randevu
          <ArrowRight className="ml-auto h-4 w-4 text-outline transition-colors group-hover:text-primary" />
        </Link>
        <Link
          to="/musteriler"
          className="group flex items-center gap-3 rounded-xl border border-outline-variant/20 bg-surface px-4 py-3 text-sm font-medium text-on-surface shadow-sm transition-all hover:border-tertiary/30 hover:shadow-md hover:text-tertiary"
        >
          <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-tertiary-container/10 transition-colors group-hover:bg-tertiary-container/20">
            <UserPlus className="h-4 w-4 text-tertiary" />
          </div>
          Yeni Müşteri
          <ArrowRight className="ml-auto h-4 w-4 text-outline transition-colors group-hover:text-tertiary" />
        </Link>
        <Link
          to="/siparisler"
          className="group flex items-center gap-3 rounded-xl border border-outline-variant/20 bg-surface px-4 py-3 text-sm font-medium text-on-surface shadow-sm transition-all hover:border-secondary/30 hover:shadow-md hover:text-secondary"
        >
          <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-secondary-container/10 transition-colors group-hover:bg-secondary-container/20">
            <Plus className="h-4 w-4 text-secondary" />
          </div>
          Yeni Sipariş
          <ArrowRight className="ml-auto h-4 w-4 text-outline transition-colors group-hover:text-secondary" />
        </Link>
      </div>
      ...
      <div className="glass-card rounded-xl p-6">
        <div className="mb-4 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-base font-semibold text-on-surface">Haftalık Karşılaştırma</h2>
          </div>
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <div className="bg-surface-container-low rounded-lg p-4">
            ...
            <div className="flex items-center justify-between">
              ...
              <span className={`text-sm font-medium ${weeklyComparison?.apptChange >= 0 ? 'text-success' : 'text-error'}`}>
                {weeklyComparison?.apptChange >= 0 ? '+' : ''}{weeklyComparison?.apptChange?.toFixed(1) || 0}%
              </span>
            </div>
          ...
          <div className="bg-surface-container-low rounded-lg p-4">
            ...
            <div className="flex items-center justify-between">
              ...
              <span className={`text-sm font-medium ${weeklyComparison?.revenueChange >= 0 ? 'text-success' : 'text-error'}`}>
                {weeklyComparison?.revenueChange >= 0 ? '+' : ''}{weeklyComparison?.revenueChange?.toFixed(1) || 0}%
              </span>
            </div>
      ...
      <div className="glass-card rounded-xl p-6">
        <div className="mb-4 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-base font-semibold text-on-surface">Saatlik Yoğunluk</h2>
          </div>
          <span className="text-xs text-on-surface-variant">Bugün</span>
        </div>
                ...
                <div className="w-full bg-surface-container-low rounded-t-lg relative" style={{ height: '100%' }}>
                  <div
                    className={`absolute bottom-0 w-full rounded-t-lg transition-all ${
                      isMorning ? 'bg-primary' : isLunch ? 'bg-secondary' : 'bg-tertiary'
                    }`}
        ...
        <div className="flex items-center justify-center gap-6 mt-4 text-xs">
          <div className="flex items-center gap-2">
            ...
            <span className="text-on-surface-variant">Sabah (09-12)</span>
          </div>
          <div className="flex items-center gap-2">
            <div className="w-3 h-3 rounded bg-secondary" />
            <span className="text-on-surface-variant">Öğle (12-14)</span>
          </div>
          <div className="flex items-center gap-2">
            <div className="w-3 h-3 rounded bg-tertiary" />
            <span className="text-on-surface-variant">Diğer</span>
          </div>
        </div>
      </div>
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <div className="glass-card rounded-xl p-6">
          <div className="mb-4 flex items-center justify-between">
            <div className="flex items-center gap-2">
              <Clock className="h-5 w-5 text-outline" />
              <h2 className="text-base font-semibold text-on-surface">Bugünkü Randevular</h2>
            </div>
            <Link to="/randevular" className="text-sm font-medium text-primary hover:text-primary-container">
              Tümü
            </Link>
          </div>
          ...
          {apptsLoading ? (
            <div className="space-y-3">
              {Array.from({ length: 3 }).map((_, i) => (
                <div key={i} className="flex items-center gap-4 rounded-xl border border-outline-variant/20 bg-surface-container-low p-3">
                  <div className="skeleton h-12 w-14 shrink-0 rounded-xl" />
            ...
            <div className="flex flex-col items-center justify-center rounded-2xl border border-dashed border-outline-variant/30 bg-surface-container-low py-12 text-center">
              <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-surface-container-highest">
                <CalendarDays className="h-6 w-6 text-outline" />
              </div>
              <p className="mt-3 text-sm font-medium text-on-surface">Bugün randevu yok</p>
              <p className="mt-1 text-xs text-on-surface-variant">Rahat bir gün, keyfini çıkarın!</p>
            </div>
          ) : (
            <div className="space-y-2">
              {todayAppointments.map((ap) => (
                <div
                  key={ap.id}
                  className="group flex items-center gap-4 rounded-xl border border-outline-variant/20 bg-surface-container-low p-3 transition-all hover:border-primary/30 hover:bg-primary-container/5 hover:shadow-sm"
                >
                  <div className="flex h-12 w-14 shrink-0 flex-col items-center justify-center rounded-xl bg-surface shadow-sm ring-1 ring-outline-variant/10">
                    <span className="text-[10px] font-semibold uppercase text-outline">{formatTime(ap.start_time)}</span>
                  </div>
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="truncate text-xs text-on-surface-variant">
                      {ap.services?.name || 'Bilinmiyor'} · {ap.customers?.phone || ''}
                    </p>
                  </div>
                  <Badge variant={apptStatusMap[ap.status]?.variant || 'default'}>
                    {apptStatusMap[ap.status]?.label || ap.status}
                  </Badge>
                </div>
              ))}
            </div>
        ...
        <div className="glass-card rounded-xl p-6">
          <div className="mb-4 flex items-center justify-between">
            <div className="flex items-center gap-2">
              <Package className="h-5 w-5 text-outline" />
              <h2 className="text-base font-semibold text-on-surface">Son Siparişler</h2>
            </div>
            <Link to="/siparisler" className="text-sm font-medium text-primary hover:text-primary-container">
              Tümü
            </Link>
          </div>
          ...
          {ordersLoading ? (
            ...
            <div className="flex flex-col items-center justify-center rounded-2xl border border-dashed border-outline-variant/30 bg-surface-container-low py-12 text-center">
              <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-surface-container-highest">
                <ShoppingBag className="h-6 w-6 text-outline" />
              </div>
              <p className="mt-3 text-sm font-medium text-on-surface">Henüz sipariş yok</p>
              <p className="mt-1 text-xs text-on-surface-variant">İlk siparişinizi oluşturun!</p>
            </div>
          ) : (
            <div className="space-y-2">
              {recentOrders.map((order) => (
                <div
                  key={order.id}
                  className="group flex items-center gap-4 rounded-xl border border-outline-variant/20 bg-surface-container-low p-3 transition-all hover:border-secondary/30 hover:bg-secondary-container/5 hover:shadow-sm"
                >
                  <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-surface shadow-sm ring-1 ring-outline-variant/10">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="truncate text-xs text-on-surface-variant">
                      {order.customers?.full_name || 'Bilinmiyor'} · {currency(order.total_amount)}
                    </p>
                  </div>
